...
export default function Logo7({ d, styles }: { d: Logo7Data; styles: Logo7Styles }) {
  return (
    <div className={cn("block relative shrink-0", styles.className)}>
      <div className="h-12 flex relative py-1.5 px-2 justify-start items-center content-center gap-1 overflow-clip">
        ...
        <div className={cn("flex relative flex-col justify-start shrink-0 min-w-0 overflow-clip line-clamp-2", styles.className2)}>
