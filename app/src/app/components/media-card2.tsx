        ...
        <div className="w-220 flex relative flex-col justify-center items-start content-start shrink-0 gap-2 max-md:w-[18.4375rem] md:max-lg:w-130 2xl:w-97.5 2xl:gap-[0.8125rem]">
          <div className="w-full flex relative justify-start items-center content-center shrink-0 gap-5 overflow-hidden">
            <div className="w-210 flex relative flex-col justify-start grow shrink-0 basis-0 whitespace-pre-wrap [word-break:break-word] [overflow-wrap:break-word] max-md:w-[15.9375rem] md:max-lg:w-120 2xl:w-87.5">
              <h4 className="hidden 2xl:block 2xl:text-color-004 2xl:[font-family:Switzer,_'Switzer_Placeholder',_sans-serif] 2xl:text-[1.625rem] 2xl:leading-[1.9375rem] 2xl:tracking-[-0.77px] 2xl:[font-feature-settings:'blwf',_'cv03',_'cv04',_'cv09',_'cv11']" dir="auto">
                {d.title}
              </h4>
              <h6 className="block text-color-004 [font-family:Switzer,_'Switzer_Placeholder',_sans-serif] text-[1.1875rem] font-medium leading-[1.5625rem] tracking-[-0.58px] [font-feature-settings:'blwf',_'cv03',_'cv04',_'cv09',_'cv11'] max-lg:text-sm max-lg:leading-[1.1875rem] max-lg:tracking-[-0.43px] 2xl:hidden" data-component="heading" dir="auto">
                {d.title2}
              </h6>
            </div>
            <div className={cn("w-5 h-5 flex relative justify-center items-center content-center shrink-0 gap-2.5 transition-transform duration-300", open ? "rotate-180" : "")}>
              <svg className="w-auto h-6 block relative shrink-0 overflow-hidden aspect-square focus:outline-clr-25 focus:[outline-style:auto] focus:outline-[5px]" data-component="icon" role="presentation" viewBox="0 0 24 24" fill="currentColor">
                <use href="#1381152623" />
              </svg>
            </div>
          </div>
          <div className="w-220 grid overflow-hidden transition-all duration-300 ease-out max-md:w-[18.4375rem] md:max-lg:w-130 2xl:w-97.5" style={{ gridTemplateRows: open ? "1fr" : "0fr", opacity: open ? 0.7 : 0, filter: open ? "blur(0px)" : "blur(3px)" }}>
            <div className="min-h-0 overflow-hidden">
              <div className="w-220 flex relative flex-col justify-start shrink-0 max-md:w-[18.4375rem] md:max-lg:w-130 2xl:w-97.5">
                <p className="block [font-family:Geist,_'Geist_Placeholder',_sans-serif] text-balance [font-feature-settings:'blwf',_'cv03',_'cv04',_'cv09',_'cv11'] text-sm font-medium leading-[1.25rem] tracking-[-0.29px] max-lg:leading-[1.1875rem] max-lg:tracking-[-0.28px] 2xl:text-base 2xl:leading-[1.3125rem] 2xl:[font-weight:inherit] 2xl:tracking-[inherit]" dir="auto">
                  {d.description}
                </p>
              </div>
            </div>
